...
class UserValidatorTest extends TestCase
{
    ...
    /** @test */
    public function isNotValidUserName(){
        $invalidFieldList = [
            [ 
                'firstname' => '' ,
                'lastname' => '' ,
    ...
    /** @test */
    public function isNotValidUserDrivingLicense(){
        $invalidFieldList = [
            [ 'drivinglicense' => '' ], 
            [ 'drivinglicense' => null ], 
    ...
    /** @test */
    public function isNotValidUserAddress(){
        $invalidFieldList = [
            [ 'address' => '' ], 
            [ 'address' => null ], 
        ];
    ...
    /** @test */
    public function isNotValidUserEmail(){
        $invalidFieldList = [
            [ 'email' => '' ], 
            [ 'email' => null ], 
            [ 'email' => ' asdf.com'], 
    ...
    /** @test */
    public function isNotValidUserPhone(){
        $invalidFieldList = [
            [ 'phone' => '' ], 
            [ 'phone' => null ], 
    ...
    /** @test */
    public function isNotValidUserRole(){
        $invalidFieldList = [
            [ 'role' => '' ], 
            [ 'role' => null ],
            [ 'role' => 'hahahah' ], 
    ...
    /** @test */
    public function isNotValidUserPassword(){
        $invalidFieldList = [
            [ 
                'password' => '',
                'confirm' => '',
